...
document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Halo Sayangcuu", "Aku punya pertanyaan niiii", "question").then(function () {
      ...
      Swal.fire("Awasss yaaa kalooo boong", "", "error").then(function () {
        ...
        const {
          ...
          inputValidator: (value) => {
            if (!value) {
              return 'isi duluu dongg sayangg :('
            } else {
              nama = value;
            }
          }
            ...
            if (result.isConfirmed) {
              Swal.fire(`${sender} juga sayang banget sama ${nama}`).then(function () {
                Swal.fire({
                  ...
                  val = e.value
                  Swal.fire(`Makasih banget ya sayangg, udah sayang sama ${sender} ${val}%`).then(function () {
                    Swal.fire({
